...
const platforms = ["cyber warriors", "cyber warriors", "cyber warriors", "cyber warriors"];

const mockCampaign = (product: string, audience: string, platform: string) => `cyber warriors`;
...
const Campaign = () => {
  ...
  const handleGenerate = () => {
    if (!product || !audience || !platform) return;
    setLoading(true);
    setResult("");
    setTimeout(() => {
      setResult(mockCampaign(product, audience, platform));
      setLoading(false);
    }, 1500);
  };
          ...
          <div className="form-card p-8 shadow-2xl">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                >
                  ...
                  {platforms.map((p, i) => <option key={`${p}-${i}`} value={p}>{p}</option>)}
                </select>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-8">
              <button
                ...
                disabled={loading || !product || !audience || !platform}
